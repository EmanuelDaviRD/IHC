            ...
            <div class="section-card">
                ...
                <div class="layout-section">
                    ...
                    <div class="admin-form" style="max-width:500px;">
                        ...
                        <input type="text" id="siteTitle" value="${settings.siteTitle || 'Edcláudia Ribeiro'}" placeholder="Nome da loja">

                        <label>Frase de Boas-vindas</label>
                        <input type="text" id="welcomeText" value="${settings.welcomeText || 'Beleza que inspira'}" placeholder="Slogan">
...
async function saveLayoutSettings() {
    ...
    try {
        ...
        localStorage.setItem('edclaudia_layout', JSON.stringify(settings));
...
function resetLayoutSettings() {
    localStorage.removeItem('edclaudia_layout');
    ...
    content.innerHTML = `
        <div class="section-card">
            ...
            <div class="admin-form" style="max-width:500px;">
                ...
                <input type="text" value="Edcláudia Ribeiro" id="storeName">
                <label>E-mail de Contato</label>
                <input type="email" value="admin@edclaudia.com" id="storeEmail">
                <label>Telefone</label>
                <input type="text" value="(88) 98107-8835" id="storePhone">
